...
from phising.data_access.phishing_data import PhishingData
...
class DataIngestion:
    ...
    def export_data_into_feature_store(self) -> DataFrame:
        ...
        try:
            ...
            logging.error(f"An error occurred in export_data_into_feature_store: {str(e)}\n{traceback.format_exc()}")
            raise PhishingException(e, sys)
    ...
    def split_data_as_train_test(self, dataframe: pd.DataFrame) -> None:
        ...
        try:
            ...
            logging.error(f"An error occurred in split_data_as_train_test: {str(e)}\n{traceback.format_exc()}")
    ...
    def initiate_data_ingestion(self) -> DataIngestionArtifact:
        ...
        try:
            ...
            logging.error(f"An error occurred in initiate_data_ingestion: {str(e)}\n{traceback.format_exc()}")
            raise PhishingException(e, sys) from e
